  ...
  education: {
    ...
    topUniversities: [
      ...
      },
      {
        ...
        globalRankQs: 50,
        city: 'Kyoto',
        notableFields: ['Chemistry (Nobel Laureates)', 'Cell Biology', 'Mathematics', 'Theoretical Physics'],
      ...
      },
      {
        ...
        globalRankQs: 80,
        city: 'Osaka',
        notableFields: ['Immunology', 'Nuclear Physics', 'Humanoid Robotics', 'Precision Engineering'],
      ...
      },
      {
        ...
        globalRankQs: 84,
        city: 'Tokyo',
        notableFields: ['Robotics', 'Materials Science', 'Supercomputing', 'Clean Energy Grid'],
      ...
      },
      {
        ...
        globalRankQs: 113,
        city: 'Sendai',
        notableFields: ['Advanced Materials Science', 'Spintronics', 'Disaster Science', 'Metallurgy'],
